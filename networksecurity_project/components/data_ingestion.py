...
from networksecurity_project.entity.config_entity import DataIngestionConfig
from networksecurity_project.entity.artifact_entity import DataIngestionArtifact
